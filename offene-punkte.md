...
6. **Verwaiste Variables: Restarbeiten** — Vollscan am 20.07. abgeschlossen (152 Komponenten, 88 mit Funden → `2-tarabao/2.2-verwaiste-variables-liste.md`). Offen: (a) Kategorie A+B massenhaft binden (mechanisch, inkl. `[twuc]-3,5` anlegen), (b) Kategorie C einzeln entscheiden, (c) Kategorie D manuell prüfen (Ausreißer wie 3020px-Padding). Die dokumentierten Alt-Funde (Nav, Footer, Featured, MegaCard, CarouselNav, ReviewCard) wurden am 20.07. korrigiert.
